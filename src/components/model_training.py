...
from src.utils.main_utils.utils import save_pickle_obj,load_pickle_object,get_evaluate
from src.utils.main_utils.utils import save_numpy_array,load_numpy_array
...
class ModelTrainer:
    ...
    def train_model(self,x_train,y_train,x_test,y_test):
        try:
            ...
            model_report:dict = get_evaluate(x_train,y_train,x_test,y_test,models,params)
